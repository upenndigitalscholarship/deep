...
let options = {
  ...
  item: function (values) {
      return `<tr id="${values.deep_id}" onclick="expand(this, ${values.deep_id});"><td class="result_number"><td class="deep_id"></td><td class="year"><td class="iconColumn"><img class="iconRow" src="/assets/img/${values.record_type.replace(/\s+/g, '')}.png" alt="${values.record_type} Icon"><span class="iconTT">${values.record_type}</span></td></td><td class="authors_display"></td><td class="item_title services title">${values.item_title}</td><td><img class="caretRow" src="/assets/img/DownArrow.png" alt="Expand Icon"></td></tr>`
  }
};
