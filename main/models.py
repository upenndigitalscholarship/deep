...
class Item(models.Model): #Previously known as "DEEP"
    ...
    stationer_printer = models.CharField("Stationer: Printer Display", max_length=1000, blank=True, null=True)
    stationer_printer_filter = models.CharField("Stationer: Printer Filter", max_length=1000, blank=True, null=True)
    stationer_publisher = models.CharField("Stationer: Publisher Display", max_length=1000, blank=True, null=True)
    ...
    stationer_bookseller = models.CharField("Stationer: Bookseller Display", max_length=1000, blank=True, null=True)
